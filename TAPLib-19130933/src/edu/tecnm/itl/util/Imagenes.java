...
:*              
:*        
:*  Archivo     : IconosUtil.java
:*  Autor       : Carlos Lopez Trujillo 19130933
:*  Fecha       : 04/10/2020
:*  Compilador  : JAVA J2SE v1.8.0
:*  Descripción : El metodo estatico cambiarTamanoIcono () es el más adecuado de usar para 
...
:*  01/03/2023  F.Gil           -Se renombró la clase y sus metodos.
:*------------------------------------------------------------------------------------------*/ 

package edu.tecnm.itl.util;
...
public class Imagenes {
    ...
    public static Icon cambiarTamanoIcono  ( Icon srcImg, int w, int h ) {
